    ...
    <section id="contact" className="py-20 lg:py-32 bg-gradient-to-b from-background to-secondary/20 overflow-hidden">
      <div className="section-container w-full">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16">
          {/* Contact Form — removed animate-slide-in-left */}
          <div>
          ...
          {/* Contact Info & Social — removed animate-slide-in-right */}
...
EOF            Ready to collaborate, learn, or discuss how we can build Africa's future together? 
            I'd love to hear from you.
          </p>
        </div>
