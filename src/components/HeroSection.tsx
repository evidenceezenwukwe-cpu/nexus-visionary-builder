...
<section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-background to-background pt-20 lg:pt-0">
      ...
      <div className="section-container relative z-10 w-full overflow-x-hidden">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center w-full">
          ...
          {/* Content */}
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left space-y-6 lg:space-y-8 animate-fade-in-up w-full">
            <div className="space-y-4 lg:space-y-6 w-full">
              ...
              <div className="space-y-2 w-full">
                ...
                <p className="text-base sm:text-lg lg:text-xl text-muted-foreground font-light leading-relaxed max-w-2xl mx-auto lg:mx-0">
                  Nigerian Law School student (Enugu Campus), founder of Evicom Concept —
            ...
            {/* Stats */}
            <div className="flex flex-wrap gap-6 sm:gap-8 justify-center lg:justify-start pt-6 lg:pt-8 w-full">
          ...
          <div className="relative flex justify-center lg:justify-end lg:order-last w-full">
            <div className="relative">
              ...
              <img
                ...
                className="relative z-10 w-56 h-56 sm:w-72 sm:h-72 lg:w-96 lg:h-96 object-cover rounded-full shadow-2xl"
              />
            </div>
          </div>
